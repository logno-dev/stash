...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!result.success) {
      ...
      setPassword('');
      setLoading(false);
      // The AuthContext will handle the redirect via isAuthenticated state
    }
  };
    ...
    <div className="login-overlay">
      <div className="login-container">
        <div className="login-header">
          <svg width="48" height="48" viewBox="0 0 593 181" xmlns="http://www.w3.org/2000/svg">
